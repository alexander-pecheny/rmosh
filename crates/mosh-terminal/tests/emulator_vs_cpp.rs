...
const PIECES: &[&[u8]] = &[
    b"\x1b[", b"\x1b]", b"\x1bP", b"\x1b", b"\xc2\x9c", b"\xc2\x9b", b"\x07", b";", b":", b"0",
    b"1", b"2", b"3", b"7", b"38", b"48", b"?", b"!", b">", b"#", b"m", b"H", b"A", b"B", b"C",
    b"D", b"J", b"K", b"L", b"M", b"P", b"X", b"@", b"r", b"n", b"c", b"d", b"G", b"S", b"T", b"g",
    b"I", b"Z", b"h", b"l", b"p", b"8", b"hello", b"\xe4\xb8\x80", b"\xc3\xa9", b"\xcc\x81",
    b"\xf0\x9f\x98\x80", b"\xff", b"\xe4", b"\n", b"\r", b"\t", b"\x08", b"\x18", b"\x1a", b"\x0b",
    b"\x0c",
];
...
fn screens_match_on_hand_written_sequences() {
    ...
    let cases: &[(&str, &[u8])] = &[
        ...
        ("wide char at margin", "aaaaaaaaaaaaaaaaaaa\u{4e00}".as_bytes()),
